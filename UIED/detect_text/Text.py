...
class Text:
    ...
    *********************
    ...
    def visualize_number(self, img, color=(255, 255, 255), font_scale=1, thickness=2, show=False, counter = 1):
        loc = self.location
        # Calculate the center of the bounding box
        center_x = loc['left'] + (loc['right'] - loc['left']) // 2
        center_y = loc['top'] + (loc['bottom'] - loc['top']) // 2
        ...
        # Put the text (number) on the image, with the specified color (default white)
